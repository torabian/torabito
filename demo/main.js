...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep app-active-streams app-card .card .card-body {\n  padding: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var DeviceSingleComponent = /** @class */ (function () {
    ...
    Object.defineProperty(DeviceSingleComponent.prototype, "descriptionLabel", {
        get: function () {
            return this.form.value.id
                ? app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.updateDescription
                : app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.createDescription;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(DeviceSingleComponent.prototype, "titleLabel", {
        get: function () {
            return this.form.value.id
                ? app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.updateTitle
                : app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.createTitle;
        },
        enumerable: false,
        configurable: true
    });
        ...
        this.dataService
            ...
            if (res.error) {
                _this.notification.showFailedMessage(app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.errorSubmit, app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].serverErrors[res.error.message] ||
                    res.error.message ||
                    app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.errorDescription);
            }
            else if (res.data) {
                _this.notification.showSuccessMessage(app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.submitUpdate, app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.submitDescription);
    ...
    Object.defineProperty(DeviceSingleComponent.prototype, "submitLabel", {
        get: function () {
            return this.form.value.id
                ? app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.update
                : app_locale_translations__WEBPACK_IMPORTED_MODULE_3__["translations"].deviceForm.create;
        },
        enumerable: false,
        configurable: true
    });
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], DeviceSingleComponent.prototype, "params", void 0);
...
/* harmony import */ var app_shared_services_navigator_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! app/shared/services/navigator.service */ "./src/app/shared/services/navigator.service.ts");
/* harmony import */ var app_shared_services_notification_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/shared/services/notification.service */ "./src/app/shared/services/notification.service.ts");
/* harmony import */ var app_shared_definitions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/shared/definitions */ "./src/app/shared/definitions.ts");
/* harmony import */ var app_shared_services_modal_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/shared/services/modal.service */ "./src/app/shared/services/modal.service.ts");
/* harmony import */ var app_locale_translations__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/locale/translations */ "./src/app/locale/translations.ts");
...
var DevicesComponent = /** @class */ (function () {
    function DevicesComponent(dataService, navigatorService, modalService, notificationService) {
        this.dataService = dataService;
        this.navigatorService = navigatorService;
        this.modalService = modalService;
        this.notificationService = notificationService;
    ...
    Object.defineProperty(DevicesComponent.prototype, "hasNoDevice", {
        get: function () {
            return !this.loading && this.devices && this.devices.length === 0;
        },
        enumerable: false,
        configurable: true
    });
    ...
    DevicesComponent.prototype.setPage = function (event) {
        var offset = event.offset * event.pageSize;
        this.queryDevice(offset, event.limit);
    };
    DevicesComponent.prototype.ngOnInit = function () {
        this.queryDevice();
    };
    DevicesComponent.prototype.queryDevice = function (offset, limit) {
        var _this = this;
    ...
    DevicesComponent.prototype.deleteItem = function (event, row) {
        var _this = this;
        event.preventDefault();
        event.stopPropagation();
        var commonHttpErrorHandler = Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpErrorResponse"]) {
                _this.notificationService.showFailedMessage(error.status.toString(), error.message);
            }
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_10__["throwError"])(error);
        });
        this.modalService
            .open({
            type: app_shared_definitions__WEBPACK_IMPORTED_MODULE_6__["ModalDialogType"].CONFIRMATION,
            title: app_locale_translations__WEBPACK_IMPORTED_MODULE_8__["translations"].devices.deleteTitle,
            description: app_locale_translations__WEBPACK_IMPORTED_MODULE_8__["translations"].devices.deleteDescription,
        })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (res) { return res.type === 'CONFIRMED'; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function () { return _this.dataService.deleteDevice(row.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (res) {
            if (res.data.deleted) {
                _this.devices = _this.devices.filter(function (device) { return device.id !== row.id; });
                _this.page = __assign(__assign({}, _this.page), { count: _this.page.count - 1 });
            }
    ...
    DevicesComponent.ctorParameters = function () { return [
        { type: _shared_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"] },
        { type: app_shared_services_navigator_service__WEBPACK_IMPORTED_MODULE_4__["NavigatorService"] },
        { type: app_shared_services_modal_service__WEBPACK_IMPORTED_MODULE_7__["ModalService"] },
        { type: app_shared_services_notification_service__WEBPACK_IMPORTED_MODULE_5__["NotificationService"] }
    ]; };
    DevicesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"],
            app_shared_services_navigator_service__WEBPACK_IMPORTED_MODULE_4__["NavigatorService"],
            app_shared_services_modal_service__WEBPACK_IMPORTED_MODULE_7__["ModalService"],
            app_shared_services_notification_service__WEBPACK_IMPORTED_MODULE_5__["NotificationService"]])
    ], DevicesComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".progress-bar-list {\n  height: 100%;\n  padding: 0.2rem 1rem 1rem;\n  border: 1px solid #ddd;\n  border-radius: 5px;\n  margin: 1rem 0;\n}\n.progress-bar-list .progress-bar-item-wrapper {\n  display: flex;\n  align-items: center;\n}\n.progress-bar-list .progress-bar-item-wrapper .progress-bar {\n  display: flex;\n  flex: 1;\n  background: rgba(43, 120, 254, 0.5);\n  min-width: 200px;\n  height: 10px;\n  border-radius: 2px;\n  margin-right: 5px;\n}\n.progress-bar-list .progress-bar-item-wrapper .progress-bar .progress {\n  display: inline-block;\n  width: 80%;\n  border-radius: 2px;\n  background-color: rgba(43, 120, 254, 0.7);\n  background-image: linear-gradient(-45deg, rgba(255, 255, 255, 0.1) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.1) 75%, transparent 75%, transparent);\n  background-size: 35px 35px;\n  -webkit-animation: cssProgressActive 1s linear infinite;\n          animation: cssProgressActive 1s linear infinite;\n  transition: width 0.2s;\n}\n.progress-bar-list .progress-bar-item-wrapper .pause-tasks,\n.progress-bar-list .progress-bar-item-wrapper .stop-tasks {\n  background: transparent;\n  border: 0;\n  border-radius: 50%;\n  margin: 0;\n  outline: none;\n  font-size: 1rem;\n  padding: 0 0.1rem;\n}\n.progress-bar-list .progress-bar-item-wrapper .pause-tasks:hover,\n.progress-bar-list .progress-bar-item-wrapper .stop-tasks:hover {\n  opacity: 0.8;\n}\n.progress-bar-list .progress-bar-item-wrapper .pause-tasks:disabled,\n.progress-bar-list .progress-bar-item-wrapper .stop-tasks:disabled {\n  opacity: 0.4;\n}\n.progress-bar-list .progress-bar-item-wrapper .stop-tasks > i {\n  display: inline-block;\n  transform: rotate(45deg);\n}\n.progress-bar-list .progress-title {\n  font-size: 0.8rem;\n  position: relative;\n  margin-bottom: 0.6rem;\n  background: #fff;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep app-settings app-card .card .card-body {\n  padding: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".welcome-page-wrapper {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  width: 100%;\n}\n.welcome-page-wrapper .welcome-logo {\n  width: 230px;\n  margin: 1rem;\n}\n@media (max-width: 992px) {\n  .welcome-page-wrapper .welcome-logo {\n    width: 200px;\n  }\n}\n.welcome-page-wrapper .shortkeys {\n  display: table;\n}\n.welcome-page-wrapper .shortkeys .shortkey {\n  display: table-row;\n}\n.welcome-page-wrapper .shortkeys .shortkey > div {\n  display: table-cell;\n  padding: 0.5rem;\n  vertical-align: middle;\n}\n.welcome-page-wrapper .shortkeys .shortkey .shortkey-title {\n  text-align: right;\n}\n.welcome-page-wrapper .shortkeys .shortkey .keys > span {\n  display: inline-block;\n  background: #fff;\n  border-radius: 3px;\n  box-shadow: inset 0px -2px 0px 0px #ddd;\n  font-size: 0.8rem;\n  padding: 0.1rem 0.5rem 0.25rem;\n  text-align: center;\n}\n.welcome-page-wrapper .extra-links {\n  display: flex;\n  margin-top: 1rem;\n}\n.welcome-page-wrapper .extra-links .extra-link {\n  padding: 1rem;\n  background: #fff;\n  margin: 1rem;\n  text-align: center;\n  max-width: 320px;\n  min-width: 280px;\n  border-radius: 3px;\n  box-shadow: 0 0 6px #dddddd78;\n  transition: all 0.2s;\n  border: 1px solid #fff;\n}\n@media (max-width: 992px) {\n  .welcome-page-wrapper .extra-links .extra-link {\n    margin: 0 1rem;\n    padding: 0.7rem 1rem;\n  }\n}\n.welcome-page-wrapper .extra-links .extra-link:hover {\n  border: 1px solid #91b9fe;\n}\n.welcome-page-wrapper .extra-links .extra-link i {\n  font-size: 1.6rem;\n  color: #5e98fe;\n}\n.welcome-page-wrapper .extra-links .extra-link .extra-link-title {\n  font-weight: 500;\n  font-size: 1rem !important;\n}\n.welcome-page-wrapper .extra-links .extra-link p {\n  font-size: 0.9rem;\n  margin: 0.7rem 0 !important;\n}\n@media (max-width: 992px) {\n  .welcome-page-wrapper .extra-links .extra-link p {\n    font-size: 0.8rem;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var translations = {
    ...
    devices: {
        deleteTitle: 'Delete time',
        deleteDescription: "You are about to delete this device, and it's entire data history. Are you sure to preceed?",
        deviceName: 'Device name',
        imei: 'Device Serial (IMEI)',
        preset: 'Device preset',
    },
    serverErrors: {
        FormValidationError: 'You have some errors in the form.',
    },
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".ngd-toast-wrapper {\n  background: transparent;\n  transition: background 0.4s;\n  font-family: \"Roboto\", sans-serif;\n}\n.ngd-toast-wrapper.vibrate {\n  -webkit-animation: rotate-scale-down-ver 0.65s linear both;\n  animation: rotate-scale-down-ver 0.65s linear both;\n}\n.ngd-toast-wrapper .ngd-toast-content {\n  background-color: #e0f7fa;\n  border-left: 1px solid #2196f3;\n  max-width: 320px;\n  padding: 15px;\n  height: auto;\n  border-radius: 2px;\n  transition-timing-function: cubic-bezier(0.33, 0.2, 0.78, 0.23);\n  transition: transform 0.4s, opacity 0.3s;\n  transform: translate(100%) scale(0.8);\n  opacity: 0;\n}\n.ngd-toast-wrapper .ngd-toast-content.theme-success {\n  border-left: 3px solid #00897b;\n  background: #e0f2f1;\n}\n.ngd-toast-wrapper .ngd-toast-content.theme-success p {\n  color: #004d40;\n}\n.ngd-toast-wrapper .ngd-toast-content.theme-warning {\n  background: #fffde7;\n  border-left: 3px solid #ffd54f;\n}\n.ngd-toast-wrapper .ngd-toast-content.theme-warning p {\n  color: #f57f17;\n}\n.ngd-toast-wrapper .ngd-toast-content.theme-info {\n  border-left: 3px solid #039be5;\n  background: #e1f5fe;\n}\n.ngd-toast-wrapper .ngd-toast-content.theme-info p {\n  color: #01579b;\n}\n.ngd-toast-wrapper .ngd-toast-content.theme-error {\n  border-left: 3px solid #f4511e;\n  background: #fbe9e7;\n}\n.ngd-toast-wrapper .ngd-toast-content.theme-error p {\n  color: #bf360c;\n}\n.ngd-toast-wrapper .ngd-toast-content.static {\n  margin: 0px;\n  box-shadow: 0 11px 15px -7px rgba(0, 0, 0, 0.2), 0 0 7px 3px rgba(0, 0, 0, 0.14), 0 9px 46px 8px rgba(0, 0, 0, 0.12);\n}\n.ngd-toast-wrapper .ngd-toast-content.active {\n  transform: translate(0) scale(1);\n  opacity: 1;\n}\n.ngd-toast-wrapper .btn {\n  margin-right: 5px;\n}\n.ngd-toast-wrapper .ngd-toast-title {\n  font-size: 24px;\n  margin-bottom: 5px;\n}\n.ngd-toast-wrapper.dialog-mode {\n  position: fixed;\n  overflow: hidden;\n  padding: 15px;\n  top: 50px;\n  z-index: 99999;\n  right: 0;\n  max-width: 400px;\n}\n.ngd-toast-wrapper.dialog-mode .ngd-toast-content {\n  box-shadow: 5px 2px 9px 3px #c0c0c03b;\n}\n.ngd-toast-wrapper.dialog-mode .ngd-toast-content p {\n  margin-bottom: 0;\n}\n@media (max-width: 767px) {\n  .ngd-toast-wrapper.dialog-mode .ngd-toast-content {\n    margin: 10px auto;\n  }\n}\n.ngd-toast-wrapper .ngd-toast-close {\n  position: absolute;\n  font-size: 32px;\n  right: 3px;\n  top: 0;\n}\n.ngd-toast-wrapper .ngd-toast-close:hover {\n  color: blue;\n}\n@-webkit-keyframes rotate-scale-down-ver {\n  0% {\n    transform: scale(1) rotateY(0);\n  }\n  50% {\n    transform: scale(0.5) rotateY(180deg);\n  }\n  100% {\n    transform: scale(1) rotateY(360deg);\n  }\n}\n@keyframes rotate-scale-down-ver {\n  0% {\n    transform: scale(1) rotateY(0);\n  }\n  50% {\n    transform: scale(0.5) rotateY(180deg);\n  }\n  100% {\n    transform: scale(1) rotateY(360deg);\n  }\n}\n.ngd-toast-text {\n  margin-right: 50px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var DataService = /** @class */ (function () {
     ...
     */
    DataService.prototype.getDevices = function (offset, limit) {
        var _this = this;
        if (offset === void 0) { offset = 0; }
        if (limit === void 0) { limit = 10; }
        return this.http
            .get(Object(_common_functions__WEBPACK_IMPORTED_MODULE_6__["API"])("api/iot/devices?offset=" + offset + "&limit=" + limit))
    ...
    DataService.prototype.deleteDevice = function (id) {
        return this.http.delete(Object(_common_functions__WEBPACK_IMPORTED_MODULE_6__["API"])('api/iot/device/' + id));
    };
